...
class PlotChain(BaseStructureChain):
    ...
    You are provided the following subject, title.
    ...
    def run(self, subject, genre, author, title):
...
class ChaptersChain(BaseStructureChain):
    ...
    def run(self, subject, genre, author,  title, plot):
...
def get_structure(subject, genre, author ):
